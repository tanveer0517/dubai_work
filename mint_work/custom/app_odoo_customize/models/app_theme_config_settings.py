...
class AppThemeConfigSettings(models.TransientModel):
    ...
    def get_default_all(self, fields):
        ...
        app_system_name = ir_config.get_param('app.window_title', default='Mint Cloud App')
        ...
        app_documentation_url = ir_config.get_param('app_documentation_url', default='http://www.erpincloud.com/#what-is-erp-in-cloud')
        app_documentation_dev_url = ir_config.get_param('app_documentation_dev_url', default='http://www.erpincloud.com/#what-is-erp-in-cloud')
        app_support_url = ir_config.get_param('app_support_url', default='http://www.erpincloud.com/signup-cloud-erp-free-trial/')
        app_account_title = ir_config.get_param('app_account_title', default='My Online Account')
        app_account_url = ir_config.get_param('app_account_url', default='http://www.erpincloud.com/contact/#reach-us')
        return dict(
    ...
    def set_default_all(self):
        ...
        ir_config.set_param("app_documentation_url", self.app_documentation_url or "http://www.erpincloud.com/#what-is-erp-in-cloud")
        ir_config.set_param("app_documentation_dev_url", self.app_documentation_dev_url or "http://www.erpincloud.com/#what-is-erp-in-cloud")
        ir_config.set_param("app_support_url", self.app_support_url or "http://www.erpincloud.com/signup-cloud-erp-free-trial/")
        ir_config.set_param("app_account_title", self.app_account_title or "My Online Account")
        ir_config.set_param("app_account_url", self.app_account_url or "http://www.erpincloud.com/contact/#reach-us")
